  ...
  def create
    ...
    respond_to do |format|
      if @configuration.save
        format.html { redirect_to(configurations_url, :notice => 'Configuration was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @configuration.update_attributes(params[:configuration])
        format.html { redirect_to(configurations_url, :notice => 'Configuration was successfully updated.') }
        format.xml  { head :ok }
      else
